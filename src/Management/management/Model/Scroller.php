...
/**
 * Scroller Class Doc Comment
 *
 * @category Class
 * @description A scroller that traverses through all index items. A scroller works like a pointer or pager. The first request initializes the scroller, returns the scroller id with the first page of items. Each subsequent request to the same scroller, identified by an id, fetch the following pages. It is important to note that the scroller works with an snapshot of the index. If you initialize a scroller and update an item later, those changes will not be reflected in the scroller. Another important aspect of Scroller is that they have an expiry time of 5 minutes.
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Scroller implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Scroller';
...
'total' => 'getTotal'    ];
     ...
     * Sets items
     *
     * @param \Swagger\Client\Model\Items $items items
     *
     * @return $this
     */
     ...
     * Sets scroll_id
     *
     * @param string $scroll_id Unique identifier for the Scroller. The id should be provided for traversing all items.
     *
     * @return $this
     */
     ...
     * Sets total
     *
     * @param int $total Total number of items fetched by the Scroller.
     *
     * @return $this
     */
