 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IndexUpdate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IndexUpdate';
     ...
     * Gets options
     *
     * @return OneOfIndexUpdateOptions
     */
     ...
     * Sets options
     *
     * @param OneOfIndexUpdateOptions $options General options of an index. The options schema are linked to the index preset. For instance, you can set `group_variants` but only for `product` presets.
     *
     * @return $this
     */
