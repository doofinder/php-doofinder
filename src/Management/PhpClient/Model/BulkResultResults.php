...
/**
 * BulkResultResults Class Doc Comment
 *
 * @category Class
 * @package  DoofinderManagement
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BulkResultResults implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BulkResult_results';
...
self::RESULT_DELETED,        ];
     ...
     * Sets error
     *
     * @param string $error Result error of the operation.
     *
     * @return $this
     */
