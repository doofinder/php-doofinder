...
class IndexUpdate implements ModelInterface, ArrayAccess
{
     ...
     * Sets options
     *
     * @param OneOfIndexUpdateOptions $options General options of an index. The options schema is linked to the index preset. For instance, you can set `group_variants` but only for `product` presets.
     *
     * @return $this
     */
