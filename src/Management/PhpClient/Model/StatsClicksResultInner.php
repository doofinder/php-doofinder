...
/**
 * StatsClicksResultInner Class Doc Comment
 *
 * @category Class
 * @package  DoofinderManagement
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StatsClicksResultInner implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StatsClicksResult_inner';
...
'title' => 'getTitle'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['dfid'] = isset($data['dfid']) ? $data['dfid'] : null;
    ...
    {
        return $this->container['dfid'];
    }

    /**
     * Sets dfid
     *
     * @param string $dfid dfid
     *
     * @return $this
     */
    public function setDfid($dfid)
    {
        $this->container['dfid'] = $dfid;
