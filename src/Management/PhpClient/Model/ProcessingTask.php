...
/**
 * ProcessingTask Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ProcessingTask implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProcessingTask';
...
'status' => 'getStatus'    ];
     ...
     * Sets finished_at
     *
     * @param string $finished_at ISO 8601 datetime string when the task has finished.
     *
     * @return $this
     */
     ...
     * Sets result
     *
     * @param string $result Result of the task. It will be just `OK` or some error description.
     *
     * @return $this
     */
