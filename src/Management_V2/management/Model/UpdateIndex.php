 ...
 *
 * @category Class
 * @description Data needed to update an index
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class UpdateIndex implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'UpdateIndex';
...
'normalization' => 'map[string,object]'    ];
...
'normalization' => 'getNormalization'    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['normalization'] = isset($data['normalization']) ? $data['normalization'] : null;
    }
     ...
     * Sets options
     *
     * @param map[string,object] $options Options of the index
     *
     * @return $this
     */
    ...
    {
        return $this->container['normalization'];
    }

    /**
     * Sets normalization
     *
     * @param map[string,object] $normalization Map the datafeed fields with doofinder fields
     *
     * @return $this
     */
    public function setNormalization($normalization)
    {
        $this->container['normalization'] = $normalization;
