...
/**
 * NewSearchEngine Class Doc Comment
 *
 * @category Class
 * @description Data needed to create/update a search engine
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class NewSearchEngine implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'NewSearchEngine';
...
'language' => 'getLanguage'    ];
     ...
     * Sets stopwords
     *
     * @param bool $stopwords Ignore high-frequency terms like \"the\", \"and\", \"is\". These words have a low weight and contribute little to the relevance score.
     *
     * @return $this
     */
     ...
     * Sets site_url
     *
     * @param string $site_url The url of the site for the search engine
     *
     * @return $this
     */
     ...
     * Sets name
     *
     * @param string $name A verbose name that helps to describe the search engine
     *
     * @return $this
     */
     ...
     * Sets language
     *
     * @param string $language An ISO 639-1 language code that determines the language of the search engine. E.g.: ‘es’.
     *
     * @return $this
     */
