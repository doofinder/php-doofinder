...
/**
 * Scroll Class Doc Comment
 *
 * @category Class
 * @description A scroll through all items
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class Scroll implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'Scroll';
...
'items' => 'getItems'    ];
     ...
     * Sets scroll_id
     *
     * @param string $scroll_id Unique identifier for the Scroll
     *
     * @return $this
     */
