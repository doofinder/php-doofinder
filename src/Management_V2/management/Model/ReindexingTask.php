...
self::STATUS_FAILURE,        ];
     ...
     * Sets progress
     *
     * @param float $progress This field indicates the progress of the reindexing operation. For instance, 0.5 would mean the task is half complete.
     *
     * @return $this
     */
     ...
     * Sets status
     *
     * @param string $status This field indicates the current status of the task, if it is running, has finished or has finished with some error.
     *
     * @return $this
     */
